...
public class WarStartEvent extends Event implements Cancellable {
    ...
    public WarStartEvent(Town attackedTown, Nation attackingNation, Nation defendingNation) {this.attackedTown = attackedTown; this.attackingNation = attackingNation; this.defendingNation =  defendingNation;}
